...
class Atom_model_pretrain(nn.Module):
    ...
    def __init__(self,
                 ...
                 output_size,
                 dropout):
        super(Atom_model_pretrain, self).__init__()
...
class Atom_model_pretrain_(nn.Module):
    """`Pushing the Boundaries of Molecular Representation for Drug Discovery with the Graph
    Attention Mechanism <https://www.ncbi.nlm.nih.gov/pubmed/31408336>`__
    ...
    def __init__(self,
                 ...
                 output_size,
                 dropout):
        super(Atom_model_pretrain_, self).__init__()
